...
class RecurrenceObserver
{
     ...
     * @return void
     */
    public static function created(Intervention $event)
    {
     ...
     * @return void
     */
    public function updated(Intervention $event)
    {
     ...
     * @return void
     */
    public function deleted(Intervention $event)
    {
        if($event->events()->exists())
            ...
            Intervention::whereIn('id', $events)->delete();
    }
}